...
const compiledCampaignByteC = require("../ethereum/build/CampaignByteC.json");
const compiledFactoryByteC = require("../ethereum/build/CampaignFactoryByteC.json");
...
beforeEach(async () => {
  ...
  factory = await new web3.eth.Contract(compiledFactory)
    .deploy({ data: "0x" + compiledFactoryByteC.object })
    .send({
      from: accounts[0],
      gas: "10000000",
    });
  ...
  campaign = await new web3.eth.Contract(compiledCampaign, campaignAddress);
});
